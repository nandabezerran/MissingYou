...
print(nova.inserirCampanha(1, 'sireioreiorerire'))
print(nova.inserirCampanha(4, 'dd'))
print(nova.inserirCampanha(4, 'sireioreiorerire'))
print(nova.selecionarImagemCampanha(1))
print(nova.selecionarImagemCampanha(4))
print(nova.excluirImagem(2, 'aaaa'))
print(nova.excluirImagem(4, 'dd'))